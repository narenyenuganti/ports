...
struct PopoverLayoutTests {
    ...
    func keyboardCommandMapping() {
        ...
        #expect(PopoverKeyboardCommand(charactersIgnoringModifiers: "3", specialKey: nil) == .appendFilter("3"))
        #expect(PopoverKeyboardCommand(charactersIgnoringModifiers: "n", specialKey: nil) == nil)
        #expect(PopoverKeyboardCommand(charactersIgnoringModifiers: "\u{F700}", specialKey: nil) == nil)
        #expect(PopoverKeyboardCommand(charactersIgnoringModifiers: "\u{F701}", specialKey: nil) == nil)
